            ...
            <div class="jen-card jen-card-secondary jen-card-hover jen-card-body jen-light">
                ...
                <div class="jen-margin">
                    ...
                    <div class="jen-inline">
                        ...
                        <span class="jen-form-icon" jen-icon="icon: user"></span>
                        <asp:TextBox ID="txtClientLname" runat="server" CssClass="jen-input" Style="width: 500px" onkeypress="countChar(this,25, 0);"></asp:TextBox>
                    </div>
                    <div class="numbersofChart"></div>
                </div>
            </div>
            ...
            <div class="jen-card jen-card-secondary jen-card-hover jen-card-body jen-light">
                ...
                <div class="jen-margin">
                    ...
                    <div class="jen-inline">
                        ...
                        <asp:TextBox ID="txtClientEmail" runat="server" CssClass="jen-input" Style="width: 500px" onkeypress="countChar(this,25, 0);"></asp:TextBox>
                    </div>
                    <div class="numbersofChart"></div>
                    <br />
                    ...
                    <div class="jen-inline">
                        ...
                        <asp:TextBox ID="txtClientPhone" runat="server" CssClass="jen-input" Style="width: 500px" onkeypress="countChar(this,25, 0);"></asp:TextBox>
                    </div>
                    <div class="numbersofChart"></div>
                    <br />
                </div>
            ...
            <div class="jen-card jen-card-secondary jen-card-hover jen-card-body jen-light">
                ...
                <div class="jen-margin">
                    ...
                    <div class="jen-inline">
                        ...
                        <asp:TextBox ID="txtClientStreet" runat="server" CssClass="jen-input" Style="width: 500px" onkeypress="countChar(this,25, 0);"></asp:TextBox>
                    </div>
                    <div class="numbersofChart"></div>
                    <br />
                    <label>City</label>
                    ...
                    <div class="jen-inline">
                        ...
                        <asp:TextBox ID="txtClientCity" runat="server" CssClass="jen-input" Style="width: 500px" onkeypress="countChar(this,25, 0);"></asp:TextBox>
                    </div>
                    <div class="numbersofChart"></div>
                    <br />
                    <label>State</label>
                    ...
                    <div class="jen-inline">
                        ...
                        <asp:TextBox ID="txtClientState" runat="server" CssClass="jen-input" Style="width: 500px" onkeypress="countChar(this,25, 0);"></asp:TextBox>
                    </div>
                    <div class="numbersofChart"></div>
                    <br />
                    <label>Zip</label>
                    ...
                    <div class="jen-inline">
                        ...
                        <asp:TextBox ID="txtClientZip" runat="server" CssClass="jen-input" Style="width: 500px" onkeypress="countChar(this,25, 0);"></asp:TextBox>
                    </div>
                    <div class="numbersofChart"></div>
                </div>
            </div>
            ...
            <div class="jen-card jen-card-secondary jen-card-hover jen-card-body jen-light">
                ...
                <div class="jen-margin">
                    ...
                    <div class="jen-inline">
                        ...
                        <asp:TextBox ID="txtClientGender" runat="server" CssClass="jen-input" Style="width: 500px" onkeypress="countChar(this,25, 0);"></asp:TextBox>
                    </div>
                    <div class="numbersofChart"></div>
                    <br />
                    ...
                    <div class="jen-inline">
                        ...
                        <asp:TextBox ID="txtClientDOB" runat="server" CssClass="jen-input" Style="width: 500px" onkeypress="countChar(this,25, 0);"></asp:TextBox>
                    </div>
                    <div class="numbersofChart"></div>
                    <br />
                </div>
